...
createEnvFile(() => {
    ...
    console.log('> npm run start:local   Start development server (local network, host = internal ip)');
    console.log('> npm run lint          Check syntax');
    console.log('> npm run run build     Build production files');
    console.log('');
